...
def search(wordstring):
    url = "http://www.dictionaryapi.com/api/v1/references/collegiate/xml/%s?key=5df5392d-be97-4dc9-b79d-889371de0aa4" % wordstring
    ...
    # see https://docs.python.org/3.5/library/xml.etree.elementtree.html#module-xml.etree.ElementTree
    return soup
